...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, mobile, password, passwordConfirm) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            } else if (res.data.data.user.role === 'driver' && res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged In Successfully!');
              window.setTimeout(function () {
                location.assign('/userDashboard');
              }, 1500);
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            res = _context3.sent;
            (0, _alerts.showAlert)('success', 'Logged Out Successfully! Thank You');
            window.setTimeout(function () {
              if (res.data.status === 'success') {
...
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js"}],"ride.js":[function(require,module,exports) {
"use strict";
...
var createRide = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(fromPlace, fromDate, toPlace, toDate, distance, rate, quantity) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Ride Added Successfully');
              window.setTimeout(function () {
                location.assign('/userDashboard');
              }, 1500);
            }
  ...
  return function createRide(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
...
var _ride = require("./ride.js");

// DOM ELEMENTS
var loginForm = document.querySelector('.form--login');
var signupForm = document.querySelector('.form--signup');
var rideForm = document.querySelector('.ride--form');
...
if (rideForm) {
  rideForm.addEventListener('submit', function (e) {
    ...
    (0, _ride.createRide)(fromPlace, fromDate, toPlace, toDate, distance, rate, quantity);
  });
}
